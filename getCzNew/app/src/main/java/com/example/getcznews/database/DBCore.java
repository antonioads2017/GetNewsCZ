...
public class DBCore extends SQLiteOpenHelper {
    ...
    private void inserirDadosDefaul(SQLiteDatabase sqLiteDatabase){
        String[] scriptTabela = new String[]{
                ...
                "INSERT INTO fonte(_id, nome,site,feed) VALUES (2, 'Paraiba Total', 'http://www.paraibatotal.com.br/', 'http://www.paraibatotal.com.br/rss-feed');",
                "INSERT INTO fonte(_id, nome,site,feed) VALUES (3, 'Senso Critico PB', 'http://www.sensocriticopb.com.br', 'http://www.sensocriticopb.com.br/rss_noticias/ultimas.xml');"
